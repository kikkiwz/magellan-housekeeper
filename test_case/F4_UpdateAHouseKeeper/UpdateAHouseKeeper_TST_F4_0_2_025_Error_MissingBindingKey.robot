...
*** Test Cases ***
################### Post ###################
UpdateAHouseKeeper_TST_F4_0_2_025_Error_MissingBindingKey 
	...
	#Body
    ${body}=    Evaluate    {"Type":"${valueType}","ConditionProperties":[{"Type":"${typeConditionProperties}","Value":${valueConditionPropertiesUpdate}}],"BindingType":"${valueBindingTypeUpdate}","Name":"${HouseKeeperName}"}
    ...
    ${responseObjectDetail}=    Set Variable    [{"Target":"BindingKey","DeveloperMessage":"The BindingKey is a required"}]

	${bodyLog}=    Set Variable    {"Type":"${valueType}","ConditionProperties":[{"Type":"${typeConditionProperties}","Value":${valueConditionPropertiesUpdate}}],"BindingType":"${valueBindingTypeUpdate}","Name":"${HouseKeeperName}"}
