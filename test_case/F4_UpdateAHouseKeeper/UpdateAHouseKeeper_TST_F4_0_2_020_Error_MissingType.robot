...
*** Test Cases ***
################### Post ###################
UpdateAHouseKeeper_TST_F4_0_2_020_Error_MissingType
	...
	#Body
    ${body}=    Evaluate    {"ConditionProperties":[{"Type":"${typeConditionProperties}","Value":${valueConditionPropertiesUpdate}}],"BindingType":"${valueBindingTypeUpdate}","BindingKey":"${valueBindingKey}","Name":"${HouseKeeperName}"}
    ...
    ${responseObjectDetail}=    Set Variable    [{"Target":"Type","DeveloperMessage":"The Type is a required"}]

	${bodyLog}=    Set Variable    {"ConditionProperties":[{"Type":"${typeConditionProperties}","Value":${valueConditionPropertiesUpdate}}],"BindingType":"${valueBindingTypeUpdate}","BindingKey":"${valueBindingKey}","Name":"${HouseKeeperName}"}
