...
*** Test Cases ***
################### Post ###################
UpdateAHouseKeeper_TST_F4_0_2_019_Error_MissingId
	...
	${urlUpdateAHouseKeeper}=    Replace String    ${URL_UPDATEAHOUSEKEEPER}    id    ${VALUE_HOUSEKEEPER_ID_INVALID}
    ...
    ${pathUrl}=    Set Variable    ${VALUE_HOUSEKEEPER_URL}/${VALUE_HOUSEKEEPER_ID_INVALID}
	${dataSearch}=    Set Variable    ${HEADER_X_AIS_ORDERREF_UPDATEAHOUSEKEEPER_FAIL}${current_timestamp}

    ${endPointName}=    Set Variable    null
	${custom}=    Set Variable    null
	${customDetailDB}=    Set Variable    null
    ${responseObjectDetail}=    Set Variable    [{"Target":"Id","DeveloperMessage":"The id is required."}]
