...
*** Test Cases ***
################### Post ###################
UpdateAHouseKeeper_TST_F4_0_2_014_Error_KeepingNameDuplicated
	...
	${valueBindingType2}=    Set Variable    ${VALUE_BINDINGTYPE_PRETENANT}
	...
	${valueBindingKey}=    Set Variable    ${PartnerId2}
