...
*** Test Cases ***
################### Post ###################
UpdateAHouseKeeper_TST_F4_0_2_026_Error_MissingName
	...
	#Body
    ${body}=    Evaluate    {"Type":"${valueType}","ConditionProperties":[{"Type":"${typeConditionProperties}","Value":${valueConditionPropertiesUpdate}}],"BindingType":"${valueBindingTypeUpdate}","BindingKey":"${valueBindingKey}"}
    ...
    ${responseObjectDetail}=    Set Variable    [{"Target":"Name","DeveloperMessage":"The Name is a required"}]

	${bodyLog}=    Set Variable    {"Type":"${valueType}","ConditionProperties":[{"Type":"${typeConditionProperties}","Value":${valueConditionPropertiesUpdate}}],"BindingType":"${valueBindingTypeUpdate}","BindingKey":"${valueBindingKey}"}
